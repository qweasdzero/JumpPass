...
namespace StarForce
{
    public class ProcedureMain : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            GameEntry.Event.Subscribe(ReturnMenuEventArgs.EventId, OnGameOver);
//            GameMode gameMode = (GameMode)procedureOwner.GetData<VarInt>(Constant.ProcedureData.GameMode).Value;
        ...
        protected override void OnLeave(ProcedureOwner procedureOwner, bool isShutdown)
        {
            ...
            GameEntry.Event.Unsubscribe(ReturnMenuEventArgs.EventId, OnGameOver);
        ...
        {
            ReturnMenuEventArgs ne = e as ReturnMenuEventArgs;
            if (ne == null)
            {
                return;
            }

            m_CurrentGame.OnGameOver();
        }
    }
}